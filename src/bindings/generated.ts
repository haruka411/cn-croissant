...
export type OpeningBookConfig = { path: string; maxPly?: number; moveRule?: OpeningBookMoveRule }
export type OpeningBookMoveRule = "bestScore" | "bestWinRate" | "positiveRandom" | "fullRandom"
